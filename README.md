...
```console
$ npm i @i-xi-dev/ms932-encoder@2.0.13
```
...
```javascript
import { Ms932 } from "https://cdn.skypack.dev/@i-xi-dev/ms932-encoder@2.0.13";
```

## Usage

### [`Ms932.Encoder`](https://doc.deno.land/https://raw.githubusercontent.com/i-xi-dev/ms932-encoder.es/2.0.13/mod.ts/~/Ms932.Encoder) class
...
### [`Ms932.EncoderStream`](https://doc.deno.land/https://raw.githubusercontent.com/i-xi-dev/ms932-encoder.es/2.0.13/mod.ts/~/Ms932.EncoderStream) class
