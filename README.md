...
```console
$ npm i @i-xi-dev/ms932-encoder@2.0.24
```
...
```javascript
import { Ms932 } from "https://www.unpkg.com/@i-xi-dev/ms932-encoder@2.0.24/esm/mod.js";
```

## Usage

### [`Ms932.Encoder`](https://doc.deno.land/https://raw.githubusercontent.com/i-xi-dev/ms932-encoder.es/2.0.24/mod.ts/~/Ms932.Encoder) class
...
### [`Ms932.EncoderStream`](https://doc.deno.land/https://raw.githubusercontent.com/i-xi-dev/ms932-encoder.es/2.0.24/mod.ts/~/Ms932.EncoderStream) class
